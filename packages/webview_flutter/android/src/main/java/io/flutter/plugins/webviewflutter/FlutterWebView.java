...
public class FlutterWebView implements PlatformView, MethodCallHandler {
    ...
    private class FlutterWebChromeClient extends WebChromeClient {
        ...
        public boolean onCreateWindow(
            ...
            final WebViewClient webViewClient = new MyWebViewClient();
    ...
    private void setupWebViewState() {
        Log.i("WEB_VIEW_TEST", "error code:" + "Finished");
        webView.loadUrl("javascript:(function() { " +
                "document.querySelector('[role=\"toolbar\"]').remove();})()");
    }

    class MyWebViewClient extends WebViewClient {
        private final long LOADING_ERROR_TIMEOUT = TimeUnit.SECONDS.toMillis(10);
        ...
        public void onReceivedError(WebView view, int errorCode, String description, String url) {
            ...
            Log.e("mOnErrorUrl", "WebViewClient: " + mOnErrorUrl);
            Log.e("mLoadingError", "WebViewClient: " + mLoadingError);
        }
        ...
        public void onPageStarted(WebView view, String url, Bitmap favIcon) {
            ...
            Log.e("onPageStarted", "WebViewClient: " + url);
        }

        @Override
        public void onPageFinished(WebView view, String url) {
            Log.e("onPageFinished", "WebViewClient: " + mUrl);
            Log.e("mLoadingError", "WebViewClient: " + mLoadingError);
            Log.e("mLoadingFinished", "WebViewClient: " + mLoadingFinished);
            url = removeLastSlash(url);
            if (startsWith(url, mUrl) && !mLoadingFinished) {
                ...
                Log.e("restart page", "WebViewClient: " + mUrl);
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            url = removeLastSlash(url);
            Log.e("OverrideUrl", "WebViewClient: " + url);
            if (!startsWith(url, mUrl) && !mLoadingFinished) {
        ...
        public void onReceivedSslError(WebView view, SslErrorHandler handler, SslError error) {
            ...
            Log.e("mLoadingError", "WebViewClient: " + error);
